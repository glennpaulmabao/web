...
export default function Home() {
  return (
    <div>
      ...
      <main>
        <section className=" bg-[#D4FF3F] w-full min-h-screen md:px-[17%] px-[8%]">
        ...
        <section className="bg-[#0B0B0B] md:h-[171.2px] md:px-[17%] px-[10%] py-10 flex items-center justify-start" >
        ...
        <section className="bg-[#171717] md:h-[171.2px] md:px-[17%] px-[10%] py-10 justify-start">
        ...
        <section className="bg-[#171717] md:px-[17%] px-[10%] flex flex-col gap-10 md:py-[120px] py-[40px] lg:flex-row lg:flex-wrap">
          <Portfolio img={web1}/>
          <Portfolio img={web2}/>
          <Portfolio img={web3}/>
          <Portfolio img={web3}/>
